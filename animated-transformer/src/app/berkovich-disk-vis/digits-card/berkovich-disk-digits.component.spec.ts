...
import { BerkovichDiskDigitsComponent } from './berkovich-disk-digits.component';
...
describe('BerkovichDiskDigitsComponent', () => {
  let component: BerkovichDiskDigitsComponent;
  let fixture: ComponentFixture<BerkovichDiskDigitsComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [BerkovichDiskDigitsComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(BerkovichDiskDigitsComponent);
