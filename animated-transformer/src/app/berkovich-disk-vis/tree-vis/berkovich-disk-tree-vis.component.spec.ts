...
import { BerkovichDiskTreeVisComponent } from './berkovich-disk-tree-vis.component';
...
describe('BerkovichDiskTreeVisComponent', () => {
  let component: BerkovichDiskTreeVisComponent;
  let fixture: ComponentFixture<BerkovichDiskTreeVisComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [BerkovichDiskTreeVisComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(BerkovichDiskTreeVisComponent);
