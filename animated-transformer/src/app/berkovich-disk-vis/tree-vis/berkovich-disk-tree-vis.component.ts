...
@Component({
  selector: 'app-berkovich-disk-tree-vis',
  templateUrl: './berkovich-disk-tree-vis.component.html',
  styleUrls: ['./berkovich-disk-tree-vis.component.scss'],
  imports: [
    CommonModule,
    MatCardModule,
    MatIconModule,
...
export class BerkovichDiskTreeVisComponent {
  // Inputs
