...
@Component({
  ...
  templateUrl: './berkovich-disk-config.component.html',
  styleUrls: ['./berkovich-disk-config.component.scss'],
  imports: [
    CommonModule,
    FormsModule,
    MatCardModule,
...
export class BerkovichDiskConfigComponent {
  // Inputs
  ...
  readonly targetLogRadiusInput = input.required<string>();
  ...
  readonly targetLogRadiusInputChange = output<string>();
  ...
  readonly targetLogRadiusBlur = output<void>();
